        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <form method="POST" class="form-control bg-dark p-5 mt-5">
                            <h1 class="text-center mb-5 text-info">Neue News anlegen</h1>
                            @csrf
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="topic" class="text-white col-form-label text-md-right">Überschrift</label>
                                    <input id="headline" type="text" class="form-control bg-secondary text-white" name="topic" value="{{ old('topic') }}" required>
                                </div>
