            ...
            <form method="POST" class="form-control bg-dark p-5 mt-5">
                        ...
                        <div class="form-group row">
                            <div class="col-md-12">
                                ...
                                <input id="headline" type="text" class="form-control bg-secondary text-white" name="headline" value="{{ $handover->headline }}" required>
                            </div>
                            <div class="col-md-12 form-outline">
                                <label for="content" class="col-form-label text-md-right text-white ">Beschreibung:</label>
                                <textarea class="form-control bg-secondary text-white" id="textAreaExample1" name="content" rows="6" value="">{{ $handover->content }}</textarea>
                            </div>
